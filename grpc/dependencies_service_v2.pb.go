...
var file_services_dependencies_service_v2_proto_goTypes = []interface{}{
...
func file_services_dependencies_service_v2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_dependencies_service_v2_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_dependencies_service_v2_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_dependencies_service_v2_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_dependencies_service_v2_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_dependencies_service_v2_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
